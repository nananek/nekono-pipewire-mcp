...
The fixture (= tests/fixtures/wpctl-status-sample.txt) is a real `wpctl status`
output captured on Arch + wireplumber 1.6.5。 Format drift in future
...
FIXTURE = Path(__file__).parent / "fixtures" / "wpctl-status-sample.txt"
